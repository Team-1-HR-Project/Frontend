  ...
  return (
    <section className="rounded-xl border border-[#d9e2ec] bg-white p-5 sm:p-6">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-[#243B53]">Department Evaluation Progress</h2>
          <p className="mt-1 text-sm text-[#829ab1]">Completion status across departments for the active review cycle.</p>
        </div>
      </div>
        ...
        <table className="w-full min-w-[850px] text-left text-sm">
          <thead className="border-b border-[#d9e2ec] text-xs uppercase tracking-wide text-[#829ab1]">
            <tr>
              ...
              <th className="pb-3">Assigned Manager</th>
              <th className="pb-3">Total Employees</th>
              <th className="pb-3">Completed / Pending</th>
          ...
          <tbody className="divide-y divide-[#eef1f4]">
            <tr>
              <td className="py-4 font-semibold text-[#243B53]">Engineering</td>
              ...
              <td className="py-4">
                <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold bg-[#e8f3eb] text-[#3f7d5a]">
                  <span className="size-1.5 rounded-full bg-current"></span>On Track
                </span>
              </td>
            </tr>
            <tr>
              <td className="py-4 font-semibold text-[#243B53]">Operations</td>
              ...
              <td className="py-4">
                <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold bg-[#fbf2df] text-[#9b6b1e]">
                  <span className="size-1.5 rounded-full bg-current"></span>Needs Attention
                </span>
              </td>
            </tr>
            <tr>
              <td className="py-4 font-semibold text-[#243B53]">Sales</td>
