      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-[#243B53]">
            {t(
              "performance.departmentProgress",
              "Department Evaluation Progress",
            )}
          </h2>
          <p className="mt-1 text-sm text-[#829ab1]">
            {t(
              "performance.departmentProgressSubtitle",
              "Completion status across departments for the active review cycle.",
            )}
          </p>
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[850px] text-left text-sm">
          <thead className="border-b border-[#d9e2ec] text-xs uppercase tracking-wide text-[#829ab1]">
            <tr>
              <th className="pb-3">
                {t("performance.departmentName", "Department Name")}
              </th>
              <th className="pb-3">
                {t("performance.assignedManager", "Assigned Manager")}
              </th>
              <th className="pb-3">
                {t("performance.totalEmployees", "Total Employees")}
              </th>
              <th className="pb-3">
                {t("performance.completedPending", "Completed / Pending")}
              </th>
              <th className="pb-3">{t("performance.progress", "Progress")}</th>
              <th className="pb-3">
                {t("performance.cycleStatus", "Cycle Status")}
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#eef1f4]">
            <tr>
              <td className="py-4 font-semibold text-[#243B53]">
            ...
            <tr>
              <td className="py-4 font-semibold text-[#243B53]">
                {t("performance.operations", "Operations")}
              </td>
              ...
              <td className="py-4">
                <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold bg-[#fbf2df] text-[#9b6b1e]">
                  <span className="size-1.5 rounded-full bg-current"></span>
                  {t("performance.needsAttention", "Needs Attention")}
                </span>
              </td>
            </tr>
            <tr>
