...
import { FiArrowUpRight, FiPlus, FiX, FiChevronDown } from "react-icons/fi";
...
const PerformancePage = () => {
  ...
  const handleSaveCycle = () => {
    ...
    if (!cycleTitle.trim()) {
      alert(t("performance.enterCycleTitle", "Please enter a cycle title."));
      return;
    }

    if (!startDate || !endDate) {
      alert(t("performance.selectDates", "Please select start and end dates."));
      return;
    }

    if (new Date(startDate) > new Date(endDate)) {
      alert(
        t("performance.invalidDates", "Start date must be before end date."),
      );
      return;
    }
    ...
    if (totalWeightage !== 100) {
      alert(
        t("performance.weightageMustBe100", "Total weightage must equal 100%."),
      );
      return;
    }
      ...
      <div className="mb-7 flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#243B53] sm:text-[28px]">
            {t("performance.title", "Performance & Goals")}
          </h1>
        ...
        >
          ...
          {t("performance.exportConfiguration", "Export configuration")}
        </button>
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_.85fr]">
          ...
          <section className="rounded-xl border border-[#d9e2ec] bg-white p-5 sm:p-6">
            <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
              ...
              >
                ...
                {t("performance.createEvaluation", "Create Evaluation Cycle")}
              </button>
            </div>
            ...
            <div className="rounded-xl border border-[#d9e2ec] bg-[#f7fafb] p-5">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#e8f3eb] px-2.5 py-1 text-xs font-semibold text-[#3f7d5a]">
                    ...
                    {t("performance.activeCycle", "Active cycle")}
                  </span>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#bcccdc] bg-white px-3.5 py-2.5 text-sm font-semibold text-[#486581] transition-colors hover:bg-[#f0f4f7]"
                >
                  {t("performance.editCycle", "Edit cycle")}
                </button>
              </div>
              ...
              <div className="mt-6">
                <div className="mb-2 flex justify-between text-xs font-semibold text-[#627d98]">
                  <span>
                    {t("performance.reviewCompletion", "Review completion")}
                  </span>
          ...
          <section className="rounded-xl border border-[#d9e2ec] bg-white p-5 sm:p-6">
            <div className="mb-6">
              <h2 className="text-lg font-bold text-[#243B53]">
                {t("performance.criteriaWeightage", "Criteria weightage")}
              </h2>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <div className="mb-2 flex justify-between text-sm">
                  <span className="font-medium text-[#486581]">
                    {t("performance.goalsDelivery", "Goals delivery")}
                  </span>
              ...
              <div>
                <div className="mb-2 flex justify-between text-sm">
                  <span className="font-medium text-[#486581]">
                    {t("performance.leadershipCulture", "Leadership & culture")}
                  </span>
          ...
          >
            ...
            <div className="mb-7 flex items-center justify-between gap-4">
              <h2 className="text-xl font-bold text-[#243B53]">
                {t("performance.createCycleTitle", "Create Evaluation Cycle")}
              </h2>
              ...
              <button
                ...
                aria-label={t("performance.close", "Close")}
              >
            ...
            <div className="mb-5">
              <label className="mb-2 block text-sm font-semibold text-[#486581]">
                {t("performance.cycleTitle", "Cycle Title")}
              </label>
            ...
            <div className="mb-6">
              <label className="mb-2 block text-sm font-semibold text-[#486581]">
                {t("performance.targetAudience", "Target Audience")}
              </label>
              ...
              <div className="relative">
                ...
                >
                  <option value="All Company">
                    {t("performance.allCompany", "All Company")}
                  </option>

                  <option value="Engineering">
                    {t("performance.engineering", "Engineering")}
                  </option>

                  <option value="HR">{t("performance.hr", "HR")}</option>

                  <option value="Finance">
                    {t("performance.finance", "Finance")}
                  </option>

                  <option value="Sales">
                    {t("performance.sales", "Sales")}
                  </option>
                </select>

                <FiChevronDown
                  className={`pointer-events-none absolute top-1/2 h-4 w-4 -translate-y-1/2 text-[#486581] ${
            ...
            <div className="mb-7">
              <h3 className="mb-5 text-base font-semibold text-[#486581]">
                {t("performance.dynamicWeightage", "Dynamic weightage")}
              </h3>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-[94px] shrink-0">
                    <input
                      ...
                      onChange={(event) =>
                        handleWeightageChange("technical", event.target.value)
                      }
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-[94px] shrink-0">
                    <input
                      ...
                      onChange={(event) =>
                        handleWeightageChange("goals", event.target.value)
                      }
                      className="h-11 w-full rounded-xl border border-[#bcccdc] bg-white px-3 text-sm font-medium text-[#486581] outline-none transition focus:border-[#486581] focus:ring-2 focus:ring-[#486581]/10"
                    />
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-[94px] shrink-0">
                    <input
                      ...
                      onChange={(event) =>
                        handleWeightageChange("leadership", event.target.value)
                      }
                      className="h-11 w-full rounded-xl border border-[#bcccdc] bg-white px-3 text-sm font-medium text-[#486581] outline-none transition focus:border-[#486581] focus:ring-2 focus:ring-[#486581]/10"
                    />
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-[94px] shrink-0">
                    <input
                      ...
                      onChange={(event) =>
                        handleWeightageChange("attendance", event.target.value)
                      }
                      className="h-11 w-full rounded-xl border border-[#bcccdc] bg-white px-3 text-sm font-medium text-[#486581] outline-none transition focus:border-[#486581] focus:ring-2 focus:ring-[#486581]/10"
                    />
              ...
              <div className="mt-5 flex items-center justify-between rounded-xl bg-[#f7fafb] px-4 py-3 text-sm">
                <span className="font-semibold text-[#486581]">
                  {t("performance.totalWeightage", "Total weightage")}
                </span>
            ...
            >
              ...
              >
                {t("performance.saveCycle", "Save cycle")}
              </button>
            </div>
          </div>
        </div>
