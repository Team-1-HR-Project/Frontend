...
const ActivityLog = () => {
  ...
  const handleExport = () => {
    toast.success(
      t("auditLogs.exportSuccess", "Audit configuration exported successfully"),
    );
  };
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex items-center gap-2 text-xs font-medium text-[#64748b]">
        ...
        <span className="text-[#334e68] font-semibold">
          {t("auditLogs.breadcrumbApp", "WiseWork")}
        </span>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#64748b] mt-1 font-normal">
            {t(
              "auditLogs.subtitle",
              "Configure and manage your WiseWork audit logs.",
            )}
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-2xl p-6 border border-[#e2e8f0]/80 shadow-[0_1px_3px_rgba(0,0,0,0.03)] space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-xl">
            <FiSearch
              className={`absolute ${isRtl ? "right-3.5" : "left-3.5"} top-1/2 -translate-y-1/2 w-4 h-4 text-[#94a3b8]`}
            />
            <input
              type="text"
              value={searchQuery}
