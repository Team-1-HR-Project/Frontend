    ...
    >
      ...
      >
        <div className="min-w-0">
          <h1 className="text-2xl font-bold tracking-tight text-[#1e293b] md:text-[28px]">
        ...
        <motion.button
          ...
          className="flex shrink-0 items-center justify-center gap-2 rounded-xl bg-[#1e293b] px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-[#0f172a]"
        >
          ...
          <motion.div variants={containerVariants} className="space-y-1">
            {attentionSignals.map((signal) => (
              <motion.div
                ...
                className="group flex items-center justify-between rounded-xl p-3 transition-colors hover:bg-[#f8fafc]"
              >
                ...
                <motion.button
                  ...
                  className="ms-3 shrink-0 rounded-lg border border-[#e2e8f0] px-3.5 py-1.5 text-xs font-semibold text-[#475569] transition hover:bg-[#f1f5f9]"
                >
